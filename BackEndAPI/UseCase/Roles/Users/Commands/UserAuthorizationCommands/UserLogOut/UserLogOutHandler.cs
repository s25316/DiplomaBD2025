...
using UseCase.Roles.Users.Commands.UserAuthorizationCommands.UserLogOut.Response;
using UseCase.Roles.Users.Repositories;
using UseCase.Shared.Services.Authentication.Inspectors;
using DomainPerson = Domain.Features.People.Aggregates.Person;

namespace UseCase.Roles.Users.Commands.UserAuthorizationCommands.UserLogOut
{
    public class UserLogOutHandler : IRequestHandler<UserLogOutRequest, UserLogOutResponse>
    {
        ...
        private static UserLogOutResponse ValidResponse()
        {
            return UserLogOutResponse.PrepareResponse(HttpCode.Ok);
        }

        private static UserLogOutResponse InvalidResponse()
        {
            return UserLogOutResponse.PrepareResponse(HttpCode.Unauthorized);
        }
