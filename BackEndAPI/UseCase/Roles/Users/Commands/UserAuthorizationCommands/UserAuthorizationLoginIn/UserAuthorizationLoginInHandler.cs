...
namespace UseCase.Roles.Users.Commands.UserAuthorizationCommands.UserAuthorizationLoginIn
{
    public class UserAuthorizationLoginInHandler : IRequestHandler<UserAuthorizationLoginInRequest, UserAuthorizationLoginInResponse>
    {
        ...
        private static UserAuthorizationLoginInResponse AuthorizationResponse(UserAuthorizationDataDto dto)
        {
