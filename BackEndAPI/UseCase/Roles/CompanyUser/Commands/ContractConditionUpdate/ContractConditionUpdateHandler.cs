...
namespace UseCase.Roles.CompanyUser.Commands.ContractConditionUpdate
{
    public class ContractConditionUpdateHandler : IRequestHandler<ContractConditionUpdateRequest, ContractConditionUpdateResponse>
    {
        // Properties
        ...
        // Constructor
        public ContractConditionUpdateHandler(
        ...
        // Methods
        public async Task<ContractConditionUpdateResponse> Handle(ContractConditionUpdateRequest request, CancellationToken cancellationToken)
        {
        ...
        private static ContractConditionUpdateResponse PrepareResponse(
            HttpCode code,
            string? message,
            ContractConditionUpdateRequest request)
        {
            return ContractConditionUpdateResponse.PrepareResponse(code, message, request.Command);
        }
        ...
        private PersonId GetPersonId(ContractConditionUpdateRequest request)
        {
