...
namespace Domain.Features.ContractConditions.Aggregates
{
    ...
    {
        public class Updater : TemplateUpdater<ContractCondition, ContractConditionId>
        {
            // Constructor
            public Updater(ContractCondition value) : base(value)
            {
            }

            // Methods
            public Updater SetSalaryRange(
                decimal minSalary,
                decimal maxSalary)
            {
            ...
            public Updater SetHoursPerTerm(int hoursPerTerm)
            {
                SetProperty(cc => cc.HoursPerTerm = hoursPerTerm);
                return this;
            }

            public Updater SetIsNegotiable(bool isNegotiable)
            {
            ...
            public Updater SetContractParameters(
