...
interface RecruitmentChatSummary{
    processId: string;
}
const ChatSummary: React.FC<RecruitmentChatSummary> =({processId}) => {
    ...
    useEffect(() => {
        ...
        if (loading || status === 'loading') {
            return <div className="text-center text-sm py-2 text-gray-500 dark:text-gray-400"></div>
        }
