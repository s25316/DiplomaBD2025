...
//         const offerTemplateId = item?.offerTemplate?.offerTemplateId;
//         const conditionIds = item?.contractConditions?.map((c: any) => c.contractConditionId) || [];
...
//           conditionIds,
//         });
//         setSelectedConditionId(conditionIds[0] || '');
...
//     const all = await refreshTemplates();
//     const match = all.find(t => t.name === newTemplateForm.name && t.description === newTemplateForm.description);

//     if (match?.offerTemplateId) {
//       setForm(prev => ({ ...prev, offerTemplateId: match.offerTemplateId }));
//       alert('Template created and selected.');
//     } else {
//       alert('Template added, but could not auto-select.');
//     }
...
//     const all = data.items.map((i: any) => i.offerTemplate);
//     setTemplates(all);
//     return all;
//   };
...
//     });
//     const data = await res.json();
//     const all = data.items.map((i: any) => i.contractCondition);
