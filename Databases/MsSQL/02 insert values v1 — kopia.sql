...
VALUES
(1, 'Internship'), -- Sta¿
(2, 'Apprenticeship'), -- Praktyki
(3, 'Employment Contract'),
(4, 'Fixed-Term Contract'), -- Umowa na czas okreœlony
(5, 'Indefinite Contract'), -- Umowa na czas nieokreœlony
...
(SkillId, Name, Description, SkillTypeId)
VALUES
...
(4006, 'Testing', 'Testowanie', 2),
(4007, 'Functional Programming', '', 2),
(4008, 'Scripting & Automation', '', 2),
(4009, 'Systems Programming', 'Systems Programming (programowanie systemowe) to obszar programowania, który koncentruje siê na tworzeniu oprogramowania niskopoziomowego, dzia³aj¹cego bezpoœrednio nad sprzêtem lub bardzo blisko systemu operacyjnego. Ten rodzaj programowania wymaga g³êbokiego zrozumienia architektury komputerów, systemów operacyjnych oraz zarz¹dzania zasobami sprzêtowymi.', 2),
...
--Shell (Bash, Zsh)
(2100, 'Bash scripts', '', 4),
(2101, 'Zsh scripts', 'do zadañ automatyzacji, zarz¹dzania systemem', 4),
--MATLAB
(2102, 'MATLAB Toolboxes', 'Signal Processing, Image Processing', 4),
...
(2135, 'MASM', '', 4),
--VBScript
(2136, 'ASP', 'Active Server Pages', 4),
